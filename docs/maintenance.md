...
Current check inventory: GitHub Pages deployment exists, but there is no pre-merge quality workflow. A deployment result alone is not a content or accessibility gate. Add content/build/browser checks before requiring them.
...
TODO: complete the scoped acceptance criteria in the [engineering follow-up](https://github.com/marinasofia/marinasofia.github.io/issues/1).
